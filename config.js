...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '12_7_04a4_10bc_1ea9').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '923051391007',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️LyFE',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || 'false'.trim(),
  RMBG_KEY: process.env.RMBG_KEY || 'yepeTQaFk7r9ymusihgXYvdN',
